...
# 執行預處理
cmd="python /kaggle/working/rsna_2024_lumbar_spine_degenerative_classification-main/preprocess_for_sagittal_stage1.py"
echo "Executing: $cmd"
eval $cmd
...
do
    ...
    do
        # 執行訓練腳本
        cmd="python /kaggle/working/rsna_2024_lumbar_spine_degenerative_classification-main/train_one_fold.py -c $config -f $fold"
        echo "Executing: $cmd"
        eval $cmd

        # 執行預測腳本
        infcmd="python /kaggle/working/rsna_2024_lumbar_spine_degenerative_classification-main/predict.py -c $config -f $fold"
...
# 設定環境變數
WORKING_DIR="/kaggle/working/rsna_2024_lumbar_spine_degenerative_classification-main"
PREPROCESS_SCRIPT="$WORKING_DIR/preprocess_for_sagittal_stage1.py"
