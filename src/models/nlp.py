...
class TransformersModel(nn.Module):
    def __init__(self, model_path, num_class, apply_dropout=True):
        ...
        if '/groups/gca50041/ariyasu/nlp_models/xlnet' not in model_path:
        ...
        if apply_dropout:
            ...
            if ('/groups/gca50041/ariyasu/nlp_models/roberta' in model_path) | ('/groups/gca50041/ariyasu/nlp_models/deberta' in model_path) | ('/groups/gca50041/ariyasu/nlp_models/albert_v2' in model_path):
                self.decoder = AutoModel.from_pretrained(model_path, hidden_dropout_prob=0, attention_probs_dropout_prob=0)
            elif '/groups/gca50041/ariyasu/nlp_models/electra' in model_path:
            ...
            elif '/groups/gca50041/ariyasu/nlp_models/bart' in model_path:
                self.decoder = AutoModel.from_pretrained(model_path, dropout=0)
            elif '/groups/gca50041/ariyasu/nlp_models/bart' in model_path:
                self.decoder = AutoModel.from_pretrained(model_path, dropout=0)
            elif '/groups/gca50041/ariyasu/nlp_models/gpt2' in model_path:
                self.decoder = AutoModel.from_pretrained(model_path,
                                                    attn_pdrop=0,
                                                    embd_pdrop=0,
                                                    resid_pdrop=0,
                                                    summary_first_dropout=0)
            elif '/groups/gca50041/ariyasu/nlp_models/xlnet' in model_path:
                if 'base' in model_path:
                    xlnet_config = XLNetConfig.from_json_file('/groups/gca50041/ariyasu/nlp_models/xlnet/xlnet-base-cased-config.json')
                else:
                    xlnet_config = XLNetConfig.from_json_file('/groups/gca50041/ariyasu/nlp_models/xlnet/xlnet-large-cased-config.json')
