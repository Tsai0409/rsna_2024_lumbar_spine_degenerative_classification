...
class Exp(MyExp):
    def __init__(self):
        ...
        self.train_ann = "/kaggle/working/duplicate/input/annotations/train_rsna_10classes_yolox_x___train_for_yolo_10level_v1_fold0_len15785.json"  # self.train_ann = '/kaggle/working/duplicate/input/annotations/train_rsna_axial_all_images_left_yolox_x___train_axial_for_yolo_all_image_v1_fold0_len9602.json'
        self.val_ann = "/kaggle/working/duplicate/input/annotations/valid_rsna_10classes_yolox_x___train_for_yolo_10level_v1_fold0_len3935.json"
        self.output_dir = "/kaggle/working/duplicate/results/rsna_10classes_yolox_x/fold0"  # absolute_path = '/kaggle/working/duplicate/results/train_rsna_axial_all_images_left_yolox_x/fold0'
