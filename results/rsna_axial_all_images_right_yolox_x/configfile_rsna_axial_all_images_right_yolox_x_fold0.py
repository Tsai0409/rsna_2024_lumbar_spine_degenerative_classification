...
class Exp(MyExp):
    def __init__(self):
        ...
        if 'yolox_x' == 'yolox_s':
            ...
            raise
        self.exp_name = 'rsna_axial_all_images_right_yolox_x'
        self.data_dir = ""

        ### need change ###
        self.max_epoch = 20
        self.train_ann = "/kaggle/working/duplicate/input/annotations/train_rsna_axial_all_images_right_yolox_x___train_axial_for_yolo_all_image_v1_fold0_len9611.json"
        self.val_ann = "/kaggle/working/duplicate/input/annotations/valid_rsna_axial_all_images_right_yolox_x___train_axial_for_yolo_all_image_v1_fold0_len1924.json"
        self.output_dir = "/kaggle/working/duplicate/results/rsna_axial_all_images_right_yolox_x/fold0"  # absolute_path = /kaggle/working/duplicate
        self.input_size = (512, 512)
        self.test_size = (512, 512)
        self.no_aug_epochs = 15 # 15
        self.warmup_epochs = 5 # 5
        self.num_classes = 1
        self.categories = [{'supercategory': 'none', 'id': 0, 'name': 'right'}]
